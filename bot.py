...
if(d.user.avatar){var img=document.createElement('img');img.src=d.user.avatar;img.onerror=function(){av.textContent=(d.user.name||'U')[0].toUpperCase()};av.appendChild(img)}
else{av.textContent=(d.user.name||'U')[0].toUpperCase()}
document.getElementById('totalScripts').textContent=d.total;
document.getElementById('runningScripts').textContent=d.running;
document.getElementById('daysLeft').textContent=d.days_left;
